				...
				<div class="col-9 row" style="margin-top: 3vh">
					<div class="container bg-light border"
						...
						<div class="question">
							...
							<button id="btnCheck" onclick="check(${idPart4})" class="btn btn-danger"
								>Check</button>
	...
	<script type="text/javascript">
       ...
       function check (idPart4) {
    	   ...
    	   $.ajax({
    	        ...
    	        url : "/toeic2020/API/checkAnswerPart4",
    	        ...
    	        explan.innerHTML= res.part4_questrionTranslate["contentEng"];
    	        
    	        //disable btn check
    	        document.getElementById("btnCheck").disabled = true;
    	        
    	        	for(var i=0;i<res.part4Questions.length;i++){
    	        	
    	        		//disable cac btn
    	        		document.getElementById("@op1_"+ res.part4Questions[i].id).disabled = true;	
    	        		document.getElementById("@op2_"+ res.part4Questions[i].id).disabled = true;	
    	        		document.getElementById("@op3_"+ res.part4Questions[i].id).disabled = true;	
    	        		document.getElementById("@op4_"+ res.part4Questions[i].id).disabled = true;	
    	        	
    	        	//	console.log(document.getElementById("@input_"+x[i].value).value);
    	        		
    	        		
    	        		if(res.part4Questions[i].isTrue == 0){
    	        			
    	        			//khi click vao btn se lay dc id cua btn do
    	        			var btnClick = document.getElementById("@btnClick_"+ res.part4Questions[i].id).value;
    	        			...
    	        			//@op1_8,@op1_9,@op1_10
    	        			if( document.getElementById("@op1_"+ res.part4Questions[i].id).name == res.part4Questions[i].op_true){
    	        				document.getElementById("@op1_"+ res.part4Questions[i].id).style.color = "green";
    	        			}
    	        			if( document.getElementById("@op2_"+ res.part4Questions[i].id).name == res.part4Questions[i].op_true){
    	        				document.getElementById("@op2_"+ res.part4Questions[i].id).style.color = "green";
    	        			}
    	        			if( document.getElementById("@op3_"+ res.part4Questions[i].id).name == res.part4Questions[i].op_true){
    	        				document.getElementById("@op3_"+ res.part4Questions[i].id).style.color = "green";
    	        			}
    	        			if( document.getElementById("@op4_"+ res.part4Questions[i].id).name == res.part4Questions[i].op_true){
    	        				document.getElementById("@op4_"+ res.part4Questions[i].id).style.color = "green";
    	        			}
    	        		}
    	        		
    	        		const explan = (res || {}).part4Questions[i].part4QuestionExplantation || null;        
    	        		...
    	        		if(explan != null){
        	        		...
        	        		var qContent= document.getElementById("@qesstionContent_"+res.part4Questions[i].id);
        	        		const meanQuesContent = (((res || {}).part4Questions[i].part4QuestionExplantation || {}).meanContent) || '';
        	        		qContent.innerHTML = res.part4Questions[i].content +" ( " + meanQuesContent + " )";
    	        			
    	        			//neu nhu cau tra loi do chua dc set nghia, thi set cho no la ''
    	        			const meanop1 = (((res || {}).part4Questions[i].part4QuestionExplantation || {}).mean_op1) || '';	
    	        			var op1 = document.getElementById("@op1_"+ res.part4Questions[i].id);
    	        		 	op1.innerHTML = "A."+ op1.name +" (" + meanop1 + ")";
    	        		 	
    	        		 	const meanop2 = (((res || {}).part4Questions[i].part4QuestionExplantation || {}).mean_op2) || '';	
    	        			var op2 = document.getElementById("@op2_"+ res.part4Questions[i].id);
    	        		 	op2.innerHTML = "B."+ op2.name +" (" + meanop2 + ")"; 
    	        		 	
    	        		 	const meanop3 = (((res || {}).part4Questions[i].part4QuestionExplantation || {}).mean_op3) || '';	
    	        			var op3 = document.getElementById("@op3_"+ res.part4Questions[i].id);
    	        		 	op3.innerHTML = "C."+ op3.name +" (" + meanop3 + ")"; 
    	        		 	
    	        		 	const meanop4 = (((res || {}).part4Questions[i].part4QuestionExplantation || {}).mean_op4) || '';	
    	        			var op4 = document.getElementById("@op4_"+ res.part4Questions[i].id);
