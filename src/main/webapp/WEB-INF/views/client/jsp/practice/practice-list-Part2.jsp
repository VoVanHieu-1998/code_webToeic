						...
						style="border-radius: 10px; padding: 3vh">
							...
							<c:forEach items="${lists}" var="list" varStatus="loop">
								<div class="question">
									...
									<a href="<c:url value="/practice/part2/detail/${list.id}"/>"><img
						...
						<c:choose>
							<c:when test="${pageInfo.indexPage == loop.index}">
								<li class="paginate_button active"
									style="background-color: teal; margin-right: 5px; width: 20px; text-align: center; color: black;">
							...
							<c:otherwise>
								<li class="paginate_button"
									...
									href="<c:url value="/train/part2/${loop.index}" />">${loop.index}</a></li>
