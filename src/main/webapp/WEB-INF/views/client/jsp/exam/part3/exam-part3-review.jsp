						...
						<form>
							...
							<div class="row" style="padding: 3vh">
								<audio controls style="margin: auto">
									<source src="<c:url value="${part3.mp3}" />">
								</audio>
							...
							<div class="question">
								...
								<c:forEach items="${part3.part3Questions}" var="q" varStatus="loop">
								...
								<a href="<c:url value="/exam/part3/detail/${groupNum}"/>"><button
							...
							function() {
								...
								$
										.ajax({
											...
											url : "/toeic2020/API/exam/part3/setStatusAnswer/"+${groupNum - 1},
