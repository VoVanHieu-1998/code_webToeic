					...
					<div class="container bg-light border"
						...
						<form>
							...
							<div class="question">
								...
								<c:forEach items="${part7.part7ReadingQuestions}" var="q"
									varStatus="loop">
								...
								<a href="<c:url value="/exam/part7/detail/${groupNum}"/>"><button
							...
							function() {
								...
								$
										.ajax({
											...
											url : "/toeic2020/API/exam/part7/setStatusAnswer/"+${groupNum - 1},
