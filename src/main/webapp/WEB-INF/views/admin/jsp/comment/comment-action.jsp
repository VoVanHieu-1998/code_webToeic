	...
	<div class="">
		<div class="page-title">
			<div class="title_left">
				<h2 style="color: red">${titlePage}</h2>
			</div>
		</div>
				...
				<div class="x_panel">
					...
					<div class="x_content">
						...
						<form:form modelAttribute="modelForm"
							...
							servletRelativeAction="/admin/vocabulary/add" method="POST"
							enctype="multipart/form-data">
							<form:hidden path="idvocabulary" />
							<form:hidden path="activeFlag" />
							
							<form:hidden path="imagevocabulary" />
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="code">Name <span class="required">*</span>
								</label>


								<div class="col-md-12 col-sm-12 col-xs-12 has-feedback">
									<form:input path="namevocabulary"
										cssClass="form-control has-feedback-left"
										disabled="${viewOnly}" />

									<div class="has-error" style="color: red;">
										<form:errors path="namevocabulary" cssClass="help-block"></form:errors>
									</div>
								</div>
							...
							<div class="form-group">
								<label class="control-label col-md-3 col-sm-3 col-xs-12"
									for="content">Content <span class="required">*</span>
								</label>
								<div class="col-md-12 col-sm-12 col-xs-12 has-feedback">
									<form:textarea path="content" id="content" name="content"
										class="form-control has-feedback-left" disabled="${viewOnly}" />

									<div class="has-error" style="color: red;">
										<form:errors path="content" cssClass="help-block"></form:errors>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function cancel() {
		window.location.href = '<c:url value="/admin/vocabulary/list" />'
	}
</script>