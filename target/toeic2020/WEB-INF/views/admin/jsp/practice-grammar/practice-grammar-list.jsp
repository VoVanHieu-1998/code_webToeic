	...
	<div class="">
		...
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				...
				<div class="x_content">
					<div class="container">
						<a href="<c:url value="/admin/grammar/add"/>" class="btn btn-app"><i
							...
							<tbody>
								...
								<c:forEach items="${grammars}" var="g" varStatus="loop">
									...
									<td class="text-center"><a
										href="<c:url value="/admin/grammar/view/${g.id }"/>"
										class="btn btn-round btn-default">View</a> <a
										href="<c:url value="/admin/grammar/edit/${g.id }"/>"
...
<script type="text/javascript">
	 function confirmDelete(id){
		 if(confirm('Do you want delete this record?')){
			 window.location.href = '<c:url value="/admin/grammar/delete/"/>'+id;
		 }
	 }
	 
	 function goToPage(page){
		 $('#searchGrammarform').attr('action','<c:url value="/admin/grammar/list/" />'+page);
